...
parser.add_argument("--gt_folder", type=str, help="path to gt folder")
parser.add_argument("--pred_folder", type=str, help="path to prediction folder")
